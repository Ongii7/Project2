...
void displayTot(double tot_expense, double tot_allowable_expense, double tot_reimbursement, double tot_amount_saved){
    ...
    printf("\nAmount saved by you: %d", tot_amount_saved);
}